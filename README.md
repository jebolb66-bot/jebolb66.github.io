...
<html lang="en">
  <head>
    ...
    <title>HALO SANTI TIUM DONG Dari ARKAN WKWK🇨🇳</title>
    <link
      rel="stylesheet"
  ...
  >
    ...
    <script>
      ...
      function ubahKartu() {
        kartu.innerHTML = `<h1 class="font-semibold text-wrap animate__animated animate__zoomIn">"Halo Buat Dunia aku 😍Aku sadar aku salah, dan aku minta maaf untuk itu," atau "Aku ingin memperbaiki kesalahan kita dan memulai babak baru bersama":).<h1>
        <h2 class="mt-3 animate__animated animate__fadeIn">- Dari : Arkan 🇨🇳 -</h2>
